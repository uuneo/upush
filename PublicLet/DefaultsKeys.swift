...
let DEFAULTSTORE = UserDefaults(suiteName: "group.upush")!
...
extension Defaults.Keys {
	...
	static let isMessageStorage = Key<Bool>(BaseConfig.isMessageStorage, default: false, suite: DEFAULTSTORE)
	...
	static let photoName = Key<String>(BaseConfig.customPhotoName, default: "Pushup.", suite: DEFAULTSTORE)
